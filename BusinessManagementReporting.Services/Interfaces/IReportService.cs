...
namespace BusinessManagementReporting.Services.Interfaces
{
    public interface IReportService
    {
        ...
        Task<AppointmentReportDto> GetAppointmentReportAsync( DateTime? startDate = null, DateTime? endDate = null, int? branchId = null, List<int>? serviceIds = null, string? status = null);
