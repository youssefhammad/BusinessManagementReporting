...
namespace BusinessManagementReporting.Core.Interfaces
{
    public interface IReportRepository
    {
        ...
        Task<List<AppointmentsByServiceDto>> GetAppointmentsByServiceAsync(
            DateTime? startDate = null,
            DateTime? endDate = null,
            int? branchId = null,
            List<int>? serviceIds = null,
            string? paymentMethod = null);
        Task<List<AppointmentsByBranchDto>> GetAppointmentsByBranchAsync(
            DateTime? startDate = null,
            DateTime? endDate = null,
            int? branchId = null,
            List<int>? serviceIds = null,
            string? paymentMethod = null);
        Task<List<AppointmentsByStatusDto>> GetAppointmentsByStatusAsync(
            DateTime? startDate = null,
            DateTime? endDate = null,
            int? branchId = null,
            List<int>? serviceIds = null,
        ...
        //Task<List<CustomerDemographicsDto>> GetCustomerDemographicsAsync(DateTime? startDate, DateTime? endDate, int? branchId);
